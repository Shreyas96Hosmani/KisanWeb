              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                    itemCount:
                                        providerListener.categoryList.length,
                                    scrollDirection: Axis.horizontal,
                                    itemBuilder: (context, index) {
                                      return CategoryTiles2(context,
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(
                          vertical: getProportionateMobileScreenHeight(20)),
                      decoration: BoxDecoration(
                        color: Color(0xFFEBF2E9),
                        border: Border.symmetric(
                            horizontal: BorderSide(color: Color(0xFFC1D0CB))),
                      ),
                      child: Column(
                        children: [
                          providerListener.featuredproductsList.length > 0
                              ? Column(
                                  children: [
                                    ...
                                    SizedBox(
                                      height: getProportionateMobileScreenHeight(15),
                                    ),
                                    Container(
                                      height:
                                          getProportionateMobileScreenHeight(
                                              200),
                                      child: ListView.builder(
                          ...
                          CustomDivider2(),
                          SizedBox(
                            height: getProportionateMobileScreenHeight(20),
                          ),
                ...
                height: getProportionateScreenHeight(30),
                    ...
                    AdTile2(context, providerListener.topAd),
                    ...
                    providerListener.productsList.length > 0
                        ? Column(
                            children: [
                              ...
                              Container(
                                height: getProportionateMobileScreenHeight(200),
                                child: ListView.builder(
                                    itemCount:
                                        providerListener.productsList.length,
                                    scrollDirection: Axis.horizontal,
                                    itemBuilder: (context, index) {
                                      return FeaturedProducts2(
                                        name: providerListener
                    ...
                    AdTile2(context, providerListener.middleAd),
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              if (index ==
                                                  (providerListener.eventList
                                                              .length >
                                                          5
                                                      ? (5)
                                                      : providerListener
                                                          .eventList.length)) {
                                                return ViewAllButton2(
                                                  OnPressed: () {
                                                    push(
                                                        context,
                                                        ViewAllWebinars(
                ...
                height: 10,
                    ...
                    AdTile2(context, providerListener.bottomAd),
//              providerListener.unread_notification_count > 0
//                  ? CustomDivider()
//                  :
                    SizedBox(
                      height: 1,
...
//                      children: [
//                        SubCatTitles(
//                          title: providerListener.unread_notification_count
//                              .toString() +
//                              " " +
...
//                  :
          ...
          : Container(
              ...
              width: double.infinity,
              padding: EdgeInsets.symmetric(
                  horizontal: getProportionateScreenWidth(200)),
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    providerListener.membershipInfo != null
...
//                                  .homeAdsList[index].organisation_id));
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    providerListener.homeAdsListImages[index]),
                                fit: BoxFit.cover),
                            boxShadow: [
                              BoxShadow(
                                color: Colors.grey[200],
...
class ViewAllButton2 extends StatelessWidget {
  final Function OnPressed;

  ViewAllButton2({this.OnPressed});

  @override
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.symmetric(
          vertical: getProportionateMobileScreenHeight(120),
          horizontal: getProportionateMobileScreenWidth(20)),
      child: ConstrainedBox(
        constraints: BoxConstraints.tightFor(
          width: getProportionateMobileScreenWidth(170),
...
class ColouredCustomButtons2 extends StatelessWidget {
  const ColouredCustomButtons2({
    Key key,
    this.bgColour,
    this.primaryColour,
    this.imgPath,
...
class InvitationTile2 extends StatelessWidget {
  const InvitationTile2({
    Key key,
  }) : super(key: key);
...
class CompanyInvitationHeader2 extends StatelessWidget {
  const CompanyInvitationHeader2({
    Key key,
  }) : super(key: key);
...
Widget LatestProductLaunch2(BuildContext context, LaunchListParser lauchOBJ) {
  return GestureDetector(
    onTap: () {
      //push(context, DemoLaunch());
    },
...
Widget LatestDemo2(BuildContext context, DemoListParser demoOBJ) {
  return GestureDetector(
    onTap: () {},
    child: Container(
      width: MediaQuery.of(context).size.width / 1.3,
...
Widget WebinarTile2(BuildContext context, WebinarListParser eventOBJ) {
  return GestureDetector(
    onTap: () {
      if (eventOBJ.type == "WSM") {
        push(context, BannerEventPage(eventOBJ.id));
    ...
    child: Container(
      width:ResponsiveWidget.isSmallScreen(context) ? getProportionateMobileScreenWidth(364) : MediaQuery.of(context).size.width / 1.3,
      margin: EdgeInsets.only(
          top: getProportionateScreenHeight(20),
          bottom: getProportionateScreenHeight(20),
          left: (20)),
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset(
                      "assets/images/filter/" + eventOBJ.language + ".png" ??
                          "",
                      fit: BoxFit.contain),
                ),
              ],
...
Widget FeaturesWebinar2(BuildContext context, WebinarListParser eventOBJ) {
  return GestureDetector(
    onTap: () {
      push(context, WebinarMainScreen(eventOBJ.id));
    },
    child: Container(
      width: getProportionateMobileScreenWidth(364),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(20),
        color: Colors.green[500],
        boxShadow: [
        ...
        image: DecorationImage(
            image: NetworkImage(eventOBJ.image_path ?? ""), fit: BoxFit.cover),
      ),
      margin: EdgeInsets.only(
        top: getProportionateScreenHeight(20),
        bottom: getProportionateScreenHeight(20),
...
class CompanyName2 extends StatelessWidget {
  const CompanyName2({
    Key key,
    this.smallthumb_url,
    this.organisation_name,
...
Widget AdTile2(BuildContext context, AdsObject adOBJ) {
  return adOBJ != null
      ? Stack(children: [
          InkWell(
            onTap: () {
...
class FeaturedBrands2 extends StatefulWidget {
  const FeaturedBrands2({
    Key key,
    this.id,
    this.organisation_name,
    this.image,
  ...
  @override
  _FeaturedBrands2State createState() => _FeaturedBrands2State();
}

class _FeaturedBrands2State extends State<FeaturedBrands2> {
  @override
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(
      ...
      width: getProportionateMobileScreenWidth(100),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Padding(
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints.tightFor(
                  width: getProportionateMobileScreenWidth(85),
                  height: getProportionateMobileScreenWidth(85)),
              child: ElevatedButton(
                  onPressed: () {
                    push(context, CompanyDetails(widget.id));
                  },
...
class FeaturedProducts2 extends StatefulWidget {
  ...
  @override
  _FeaturedProducts2State createState() => _FeaturedProducts2State();
}

class _FeaturedProducts2State extends State<FeaturedProducts2> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: widget.onPressed,
      child: Container(
        ...
        height: getProportionateMobileScreenHeight(212),
        decoration: BoxDecoration(boxShadow: [
          BoxShadow(
            color: Colors.grey[200],
            offset: const Offset(
        ...
        margin: EdgeInsets.only(
            ...
            bottom: getProportionateMobileScreenWidth(10),
...
Widget CategoryTiles2(BuildContext context, CategoryListParser categoryOBJ) {
  return Column(
    children: [
      Container(
        width: getProportionateMobileScreenWidth(85),
        ...
        child: Column(
          ...
          children: [
            ConstrainedBox(
              constraints: BoxConstraints.tightFor(
                width: getProportionateMobileScreenWidth(87),
                height: getProportionateMobileScreenHeight(79),
              ),
              child: ElevatedButton(
                onPressed: () {
                  push(
...
class SubCatTitles2 extends StatelessWidget {
  const SubCatTitles2({
    Key key,
    this.title,
    this.image,
